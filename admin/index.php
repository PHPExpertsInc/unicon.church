...
li { margin-bottom: 13px; }
    ...
    <div id="wrapper">
        ...
        <article class="post editable" data-save-id="post-core_principles">
            <header>
                    ...
                    <div class="4u">
                        ...
                        <div id="sidebar">
                            <div class="inner">
                                ...
                                <!-- About -->
                                <section class="widget widget-about editable" id="main-about_us">
                                    <header>
                                        <h2>About Us</h2>
                                    </header>
    ...
    <script>
        $(function() {
            ...
            $(".editable").on('editable.beforeSave', function (e, editor, data) {
                editor.option('saveParams', { contentId: editor.option('saveId') });
            });
        });
    </script>
    </body>
